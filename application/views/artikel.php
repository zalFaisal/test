...
<html>
	...
	<title>Learnoscope | Cek Jantung</title>
	...
	<div id="page">
		...
		<div class="colorlib-trainers">
            ...
            <div class="panel panel-warning">
                <div class="panel-heading">Rekam Detak Jantung</div>
                <div class="panel-body text-center">
                    ...
                    <div id="record_btn_control" style="display: none">
                        ...
                        <button id="" class="btn btn-warning" onclick=" window.location='<?=site_url('');?>'">Cek Lagi</button>
                    </div>
            ...
            <div class="panel panel-success">
                ...
                <p class="heading">1. Pan Systolic Murmur</p>
                ...
                <br><br><br>
                <p class="heading">2. Suara Detang Jantung S3</p>
                ...
                <p class="heading">3. Detak Jantung Normal</p>
                ...
                <br><br><br>
                <p class="heading">4. Election Systolic Murmur</p>
                ...
                <p class="heading">5. Early Diastolic Decrescendo Murmur</p>
                ...
                <br><br><br>
                <p class="heading">6. Election Systolic Murmur With Splitting of the S2</p>
                ...
                <p class="heading">7. Machinery Murmur</p>
                ...
                <br><br><br>
                <p class="heading">8. Suara Detang Jantung S4</p>
                <div id="waveform8"></div>
                <label>
    				Zoom: <input type="range" min="10" max="1000" value="100" id="slider8" />
  				</label><br>
                <button id="btnPlay8" class="btn btn-warning">Play/Pause</button><br><br><br>

                <p class="heading">9. Mid Diastolic Murmur</p>
                <div id="waveform9"></div>
                <label>
    				Zoom: <input type="range" min="10" max="1000" value="100" id="slider9" />
  				</label><br>
                <button id="btnPlay9" class="btn btn-warning">Play/Pause</button>
                <br><br><br>
  ...
  url: '<?=base_url();?>/assets/Detak/JANTUNG--1.mp3?0230',
})
...
//---------------------------------------
 const wavesurfer2 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--2.mp3?0230',
})
...
playButton2.onclick = () => {
 ...
 const wavesurfer3 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--3.mp3?0230',
})
...
//---------------------------------------
 const wavesurfer4 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--4.mp3?0230',
})
...
playButton4.onclick = () => {
 ...
 const wavesurfer5 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--5.mp3?0230',
})
...
//---------------------------------------
 const wavesurfer6 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--6.mp3?0230',
})
...
playButton6.onclick = () => {
 ...
 const wavesurfer7 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--7.mp3?0230',
})
...
//---------------------------------------
 const wavesurfer8 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--8.mp3?0230',
})
wavesurfer8.once('decode', () => {
  const slider8 = document.querySelector('#slider8')

  slider8.addEventListener('input', (e) => {
    const minPxPerSec = e.target.valueAsNumber
    wavesurfer8.zoom(minPxPerSec)
  })
})
wavesurfer8.once('decode', () => {
playButton8.onclick = () => {
 ...
 const wavesurfer9 = WaveSurfer.create({
  ...
  waveColor: '#B31C45',
  progressColor: '#B31C45',
  url: '<?=base_url();?>/assets/Detak/JANTUNG--9.mp3?0230',
})
wavesurfer9.once('decode', () => {
  const slider9 = document.querySelector('#slider9')

  slider9.addEventListener('input', (e) => {
    const minPxPerSec = e.target.valueAsNumber
    wavesurfer9.zoom(minPxPerSec)
  })
})
wavesurfer9.once('decode', () => {
playButton9.onclick = () => {
